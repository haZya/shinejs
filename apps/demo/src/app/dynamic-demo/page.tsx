...
const DynamicDemo: React.FC = () => {
  ...
  const handleBlurPowChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleOpacityPowChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleOffsetPowChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-20 p-16">
      <div className="grid sm:grid-cols-2 gap-6 w-full">
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="blurPow" className="font-medium">Blur Power: {blurPow.toFixed(2)}</label>
          <input
            id="blurPow"
            type="range"
            min="0"
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="opacityPow" className="font-medium">Opacity Power: {opacityPow.toFixed(2)}</label>
          <input
            id="opacityPow"
            type="range"
            min="0"
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="offset" className="font-medium">Offset: {offset.toFixed(2)}</label>
          <input
            id="offset"
            type="range"
            min="0"
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="offsetPow" className="font-medium">Offset Power: {offsetPow.toFixed(2)}</label>
          <input
            id="offsetPow"
            type="range"
            min="0"
